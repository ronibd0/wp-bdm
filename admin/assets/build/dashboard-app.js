...
const Astra_Admin_Icons = {
  'play': (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)('svg', {
    width: 20,
    height: 20,
    viewBox: '0 0 20 20',
    fill: 'none'
...
const QuickSettings = () => {
  const AllQuickLinks = [{
    name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Site Identity', 'astra'),
    section: astra_admin.customize_url + '?autofocus[control]=custom_logo',
    isPro: false
  }, {
    name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Color Options', 'astra'),
    section: astra_admin.customize_url + '?autofocus[section]=section-colors-background',
    isPro: false
  }, {
    name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Typography', 'astra'),
    section: astra_admin.customize_url + '?autofocus[section]=section-typography',
    isPro: false
  }, {
    name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Header Builder', 'astra'),
    section: astra_admin.customize_url + '?autofocus[section]=section-header-builder-layout',
    isPro: false
  }, {
    name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Layout', 'astra'),
    section: astra_admin.customize_url + '?autofocus[section]=section-container-layout',
    isPro: false
  }, {
    name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Button', 'astra'),
    section: astra_admin.customize_url + '?autofocus[section]=section-buttons',
    isPro: false
  }, {
    name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Nav Menu', 'astra'),
    section: astra_admin.admin_base_url + 'nav-menus.php',
    isPro: true
  }, {
    name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('White Label', 'astra'),
    section: astra_admin.admin_url + '?page=' + astra_admin.home_slug + '&path=settings',
    isPro: true
  }, {
    name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('WooCommerce', 'astra'),
    section: astra_admin.customize_url + '?autofocus[panel]=woocommerce',
    isPro: true
  }, {
    name: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Sticky Headers', 'astra'),
  ...
  const renderBlockCards = AllQuickLinks.map((block, index) => {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      key: index,
      className: classNames(block.isPro ? 'bg-slate-50' : 'bg-white', 'box-border relative border rounded-md h-20 p-4 flex items-center gap-x-4 snap-start hover:shadow-md transition spectra-icon-transition')
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "uagb-admin-block-card__title flex-1 min-w-0"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
      className: "text-base font-medium text-slate-800 leading-7"
    }, block.name), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
      className: classNames(block.isPro ? 'pointer-events-none' : '', 'focus:text-slate-400 text-slate-400 text-base truncate leading-7 focus:text-spectra focus-visible:text-spectra-hover active:text-spectra-hover hover:text-spectra-hover'),
      href: block.section,
      rel: "noreferrer"
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Customize', 'astra'))), block.isPro && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "relative inline-flex flex-shrink-0 py-0.5 px-1 text-[0.625rem] text-white bg-slate-800 rounded-[0.1875rem]"
...
/* harmony default export */ __webpack_exports__["default"] = (QuickSettings);
...
const Welcome = () => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("main", {
    ...
    className: "font-medium text-base text-slate-800"
    ...
    className: "lg:flex-shrink-0 text-sm text-spectra focus:text-spectra focus-visible:text-spectra-hover active:text-spectra-hover hover:text-spectra-hover no-underline",
    href: astra_admin.customize_url,
    target: "_self",
    rel: "noreferrer"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Go to Customizer', 'astra'))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_DashboardApp_pages_Welcome_QuickSettings__WEBPACK_IMPORTED_MODULE_2__["default"], null)))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "text-slate-800 text-base font-medium pb-2"
    ...
    className: "text-slate-500 text-sm pb-[20px] pr-2"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Learn everything you need to know about the Astra Theme with our comprehensive documentation.', 'astra')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    className: "text-sm text-spectra focus:text-spectra focus-visible:text-spectra-hover active:text-spectra-hover hover:text-spectra-hover no-underline",
    href: "https://wpastra.com/docs/",
    target: "_blank",
    rel: "noreferrer"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Browse Now →', 'astra'))))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("section", {
    "aria-labelledby": "section-2-title"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", {
    className: "sr-only",
    id: "section-2-title"
  }, "Section title"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "relative box-border border border-blue-400 border-slate-50 rounded-md bg-slate-100 shadow-sm overflow-hidden transition hover:shadow-hover"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "p-8 pr-10"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", {
    className: "relative flex items-center text-slate-800 text-base font-medium pb-2"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "flex-1"
    ...
    className: "inline-flex leading-4 flex-shrink-0 py-0.5 px-1 text-[0.625rem] text-white bg-slate-800 rounded-[0.1875rem]"
    ...
    target: "_blank",
    rel: "noreferrer"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Learn More →', 'astra'))))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("section", {
    "aria-labelledby": "section-2-title"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", {
    className: "sr-only",
    id: "section-2-title"
    ...
    target: "_blank",
    rel: "noreferrer"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Join Now →', 'astra'))))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("section", {
    "aria-labelledby": "section-2-title"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", {
    className: "sr-only",
    id: "section-2-title"
    ...
    className: "text-slate-800 text-base font-medium pb-2"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Rate Us', 'astra')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    className: "text-slate-500 text-sm pb-[10px] pr-2"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "text-2xl text-slate-800"
  }, " \u2605\u2605\u2605\u2605\u2605 "), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "align-text-bottom text-slate-400"
    ...
    className: "text-slate-500 text-sm pb-[20px] pr-2"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('We love to hear from you, we would appreciate every single review.', 'astra')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    className: "text-sm text-spectra focus:text-spectra focus-visible:text-spectra-hover active:text-spectra-hover hover:text-spectra-hover no-underline",
