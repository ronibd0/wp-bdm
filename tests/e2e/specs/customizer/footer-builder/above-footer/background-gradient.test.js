...
describe( 'above footer background gradient setting in customizer', () => {
	it( 'background gradient should apply correctly', async () => {
		...
		await expect( {
			...
			`${ aboveFooter[ 'hba-footer-bg-obj-responsive' ].desktop[ 'background-color' ] }`,
		);
		...
		await expect( {
			...
			`${ aboveFooter[ 'hba-footer-bg-obj-responsive' ].tablet[ 'background-color' ] }`,
		);
		...
		await expect( {
			...
			`${ aboveFooter[ 'hba-footer-bg-obj-responsive' ].mobile[ 'background-color' ] }`,
		);
	} );
} );
