...
function astra_post_single_structure_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {
	...
	if ( 'layout-1' === $layout_type ) {
		...
		$css_output_desktop = array(
			...
			$selector . ', ' . $selector . ' *'     => astra_get_font_array_css( 'ast-dynamic-single-' . $current_post_type . '-text-font-family', 'ast-dynamic-single-' . $current_post_type . '-text-font-weight', $banner_text_font_size, 'ast-dynamic-single-' . $current_post_type . '-text-font-extras', $text_color ),
