		...
		public function markup_meta_box( $post ) {
			...
			<div class="disable-section-meta-wrap components-base-control__field">
				...
				<div class="disable-section-meta">
					...
					<?php if ( $show_meta_field && Astra_Builder_Helper::is_row_empty( 'above', 'header', 'desktop' ) && true === Astra_Builder_Helper::$is_header_footer_builder_active ) : ?>
					...
					<?php if ( $show_meta_field && Astra_Builder_Helper::is_row_empty( 'below', 'header', 'desktop' ) && true === Astra_Builder_Helper::$is_header_footer_builder_active ) : ?>
					...
					$temp = Astra_Builder_Helper::$is_header_footer_builder_active
					?>
