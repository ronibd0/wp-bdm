...
( function( $ ) {
	...
	for ( var index = 0; index < postTypesCount; index++ ) {
		...
		astra_font_extras_css( 'ast-dynamic-archive-' + postType + '-title-font-extras', '.ast-archive-entry-banner[data-post-type="' + postType + '"] .ast-container h1, body.archive .ast-archive-description h1, .ast-archive-entry-banner[data-post-type="' + postType + '"] .ast-container h1 *, body.archive .ast-archive-description h1 *' );
		...
		astra_font_extras_css( 'ast-dynamic-archive-' + postType + '-text-font-extras', '.ast-archive-entry-banner[data-post-type="' + postType + '"] .ast-container *, body.archive .ast-archive-description, body.archive .ast-archive-description *' );
	}
