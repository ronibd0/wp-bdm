...
(function ($) {
	...
	function headingDynamicCss(slug) {
		...
		astra_generate_outside_font_family_css(
			"astra-settings[font-family-" + slug + "]",
			slug + ", .entry-content " + slug + anchorSupport
		);
		astra_generate_font_weight_css(
			"astra-settings[font-family-" + slug + "]",
			"astra-settings[font-weight-" + slug + "]",
			"font-weight",
			slug +
				", .entry-content " +
				slug +
		...
		wp.customize(
			"astra-settings[font-extras-" + slug + "]",
			function (value) {
				value.bind(function (data) {
					...
					// Line Height
					const globalSelectorLineHeight =
						slug +
						", .entry-content " +
						slug +
						elementorSupport +
	...
	if (astraCustomizer.page_builder_button_style_css) {
		...
		if (
			"color-typo" ==
				astraCustomizer.elementor_default_color_font_setting ||
		...
		astra_generate_outside_font_family_css(
			...
			'button, .ast-button, .ast-custom-button, input#submit, input[type="button"], input[type="submit"], input[type="reset"], .wp-block-button .wp-block-button__link, form[CLASS*="wp-block-search__"].wp-block-search .wp-block-search__inside-wrapper .wp-block-search__button' +
				ele_btn_font_family
		);
		astra_generate_font_weight_css(
			"astra-settings[font-family-button]",
		...
		astra_css(
			"astra-settings[text-transform-button]",
			"text-transform",
			'button, .ast-button, .ast-custom-button, input#submit, input[type="button"], input[type="submit"], input[type="reset"], .wp-block-button .wp-block-button__link, form[CLASS*="wp-block-search__"].wp-block-search .wp-block-search__inside-wrapper .wp-block-search__button' +
				ele_btn_transform
		);
		...
		astra_css(
			"astra-settings[theme-btn-line-height]",
			"line-height",
			'button, .ast-button, .ast-custom-button, input#submit, input[type="button"], input[type="submit"], input[type="reset"], .wp-block-button .wp-block-button__link, form[CLASS*="wp-block-search__"].wp-block-search .wp-block-search__inside-wrapper .wp-block-search__button' +
				ele_btn_line_height
		);
		astra_css(
			"astra-settings[theme-btn-letter-spacing]",
			"letter-spacing",
			'button, .ast-button, .ast-custom-button, input#submit, input[type="button"], input[type="submit"], input[type="reset"], .wp-block-button .wp-block-button__link, form[CLASS*="wp-block-search__"].wp-block-search .wp-block-search__inside-wrapper .wp-block-search__button' +
				ele_btn_letter_spacing,
			"px"
		...
		astra_generate_outside_font_family_css(
			"astra-settings[font-family-button]",
			'button, .ast-button, .ast-custom-button, input#submit, input[type="button"], input[type="submit"], input[type="reset"]'
		);
		astra_generate_font_weight_css(
			"astra-settings[font-family-button]",
			"astra-settings[font-weight-button]",
