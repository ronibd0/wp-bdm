...
const CopyPasteStyles = () => {
    ...
    const updateEnableCopyPasteStylesStatus = () => {
		...
		formData.append( 'security', astra_admin.copy_paste_nonce );
    ...
    return (
		<section className='block border-b border-solid border-slate-200 px-12 py-8 justify-between'>
            ...
            <p className="mt-2 w-9/12 text-sm text-slate-500">
                { __( 'Enable the "Copy Paste Styles" option to have the ability to copy & paste Spectra & Core Gutenberg Blocks Styles.', 'astra' ) }
            </p>
        </section>
    );
};
