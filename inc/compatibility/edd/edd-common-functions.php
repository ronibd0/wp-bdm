...
if ( ! function_exists( 'astra_edd_terms_list' ) ) {
	...
	<div class="ast-edd-download-categories">
		<?php foreach ( $terms as $term ) : ?>
			...
			?>
			<?php // @codingStandardsIgnoreStart /** @psalm-suppress PossiblyInvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort ?>
			<a href="<?php echo esc_url( $term_link ); ?>" title="<?php echo esc_attr( $term->name ); ?>"> <?php echo esc_html( $term->name ); ?> </a>
			<?php // @codingStandardsIgnoreEnd /** @psalm-suppress PossiblyInvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort ?>
			<?php
		endforeach; 
		?>
	</div>
