...
const LegacyBlocks = () => {
    ...
    const updateEnableLegacyBlocks = () => {
		...
		formData.append( 'security', astra_admin.enable_legacy_blocks_nonce );
    ...
    return (
        <section className='block border-b border-solid border-slate-200 px-12 py-8 justify-between'>
            ...
            <p className="mt-2 w-9/12 text-sm text-slate-500">
                { __( 'Enable this option to enable the support of our Legacy Blocks on the site.', 'astra' ) }
            </p>
        </section>
    );
};
