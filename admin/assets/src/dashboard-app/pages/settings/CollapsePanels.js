...
const CollapsePanels = () => {
    ...
    const updateEnableCollapsePanelsStatus = () => {
		...
		formData.append( 'security', astra_admin.collapse_panels_nonce );
    ...
    return (
        <section className='block border-b border-solid border-slate-200 px-12 py-8 justify-between'>
            ...
            <p className="mt-2 w-9/12 text-sm text-slate-500">
                { __( 'Enable the "Collapse Panels" option if you want to Collapse all other Panels in your Blocks Settings except for the one which is clicked This way you have only one Panel of Settings in front of you to Focus on.', 'astra' ) }
            </p>
        </section>
    );
};
