...
const ContainerGlobalPadding = () => {
	...
	const saveValue = ( value, showNotice = true ) => {
		...
		formData.append( 'security', astra_admin.container_global_padding_nonce );
    ...
    return (
        <section className='block border-b border-solid border-slate-200 px-12 py-8 justify-between'>
            ...
            <p className="mt-2 w-9/12 text-sm text-slate-500">
                { __( 'This setting will apply default padding in the Container Block.', 'astra' ) }
            </p>
        </section>
    );
};
