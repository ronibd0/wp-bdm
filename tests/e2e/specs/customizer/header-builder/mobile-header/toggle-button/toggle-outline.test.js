...
describe( 'toggle button outline layout settings in the customizer', () => {
	it( 'toggle button outline layout settings should apply correctly', async () => {
		...
		await expect( {
			selector: '[data-section="section-header-mobile-trigger"] .ast-button-wrap .ast-mobile-menu-trigger-outline',
			property: 'border-top-width',
		} ).cssValueToBe(
			`${ toggleOutline[ 'mobile-header-toggle-btn-border-size' ].top + 'px' }`,
		);
		await expect( {
			selector: '[data-section="section-header-mobile-trigger"] .ast-button-wrap .ast-mobile-menu-trigger-outline',
			property: 'border-right-width',
		} ).cssValueToBe(
			`${ toggleOutline[ 'mobile-header-toggle-btn-border-size' ].right + 'px' }`,
		);
		await expect( {
			selector: '[data-section="section-header-mobile-trigger"] .ast-button-wrap .ast-mobile-menu-trigger-outline',
			property: 'border-bottom-width',
		} ).cssValueToBe(
			`${ toggleOutline[ 'mobile-header-toggle-btn-border-size' ].bottom + 'px' }`,
		);
		await expect( {
			selector: '[data-section="section-header-mobile-trigger"] .ast-button-wrap .ast-mobile-menu-trigger-outline',
			property: 'border-left-width',
		} ).cssValueToBe(
			`${ toggleOutline[ 'mobile-header-toggle-btn-border-size' ].left + 'px' }`,
		);
		...
		await expect( {
			selector: '[data-section="section-header-mobile-trigger"] .ast-button-wrap .mobile-menu-wrap .mobile-menu',
			property: 'font-size',
		} ).cssValueToBe(
		...
		await expect( {
			selector: '[data-section="section-header-mobile-trigger"] .ast-button-wrap .menu-toggle',
			property: 'margin-top',
		} ).cssValueToBe(
