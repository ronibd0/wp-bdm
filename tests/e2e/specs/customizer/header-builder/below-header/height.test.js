...
describe( 'Below header height setting in customizer', () => {
	it( 'height should apply correctly', async () => {
		...
		await expect( {
			...
			property: 'min-height',
		} ).cssValueToBe( `${ belowHeaderHeight[ 'hbb-header-height' ].desktop }${ belowHeaderHeight[ 'hbb-header-height' ][ 'desktop-unit' ] }`,
		);
		...
		await expect( {
			...
			property: 'min-height',
		} ).cssValueToBe( `${ belowHeaderHeight[ 'hbb-header-height' ].tablet }${ belowHeaderHeight[ 'hbb-header-height' ][ 'tablet-unit' ] }`,
		);
		...
		await expect( {
			selector: '.ast-mobile-header-wrap .ast-below-header-bar',
			property: 'min-height',
		} ).cssValueToBe( `${ belowHeaderHeight[ 'hbb-header-height' ].mobile }${ belowHeaderHeight[ 'hbb-header-height' ][ 'mobile-unit' ] }`,
		);
	} );
} );
