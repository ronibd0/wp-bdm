	        	...
	        	wp.customize.bind(\'ready\', function() {
	            	wp.customize.control.each(function(ctrl, i) {
	                	...
	                	if( desc.length) {
	                    	...
	                    	desc.remove();
	                    	li_wrapper.append(" <i class=\'roshan ast-control-tooltip dashicons dashicons-editor-help\'data-title=\'" + tooltip +"\'></i><span class=\'ast-dashicons-custom-tooltip\'data-title=\'" + tooltip + "\'><span>");
	                	}
	            	});
	        	});';
