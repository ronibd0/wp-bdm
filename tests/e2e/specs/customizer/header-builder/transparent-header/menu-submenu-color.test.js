...
describe( 'Transparent header settings in the customizer', () => {
	it( 'menu text color setting should apply correctly', async () => {
		...
		await page.waitForSelector( '.ast-theme-transparent-header .ast-builder-menu .main-header-menu .menu-link' );
		await expect( {
			selector: '.ast-theme-transparent-header .ast-builder-menu .main-header-menu .menu-link',
			property: 'color',
		} ).cssValueToBe( `${ menuTextColor[ 'transparent-menu-color-responsive' ].desktop }` );

		await setBrowserViewport( 'medium' );
		await page.click( '.main-header-menu-toggle' );
		await page.waitForSelector( '.ast-theme-transparent-header .ast-builder-menu .main-header-menu .menu-item > .menu-link' );
		await expect( {
			selector: '.ast-theme-transparent-header .ast-builder-menu .main-header-menu .menu-item > .menu-link',
			property: 'color',
