		...
		public static function return_output( $dynamic_css, $dynamic_css_filtered = '' ) {
			...
			if ( self::page_title_container_alignment_compatibility() ) {
				...
				$page_title_container_alignment_css = array(
					...
					'.ast-plain-container.ast-plain-container.ast-plain-container.entry-content > .alignfull, .ast-page-builder-template .ast-no-sidebar .entry-content > .alignfull' => array(
						'margin-left'          => '0',
						'margin-right'         => '0',
						'padding-' . $ltr_left => '0',
					),
					'.ast-plain-container.ast-no-sidebar .entry-content > .alignfull, .ast-plain-container .entry-content .alignfull, .ast-plain-container.ast-no-sidebar.ast-plain-container.ast-no-sidebar .entry-content > .wp-block-uagb-container' => array(
						'margin-left'          => '0',
						'margin-right'         => '0',
						'width'                => 'initial',
						'padding-' . $ltr_left => '0',
					...
					'.ast-page-builder-template .entry-content .alignfull' => array(
						'margin-left'          => '0',
						'margin-right'         => '0',
						'padding-' . $ltr_left => '0',
					),
					'.ast-page-builder-template .entry-content .wp-block-uagb-container' => array(
						'padding-' . $ltr_left => '0',              
					),
