...
function astra_hb_woo_cart_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {
	...
	*/
	...
	$css_output_mobile = array(
		...
		'.ast-header-break-point.ast-hfb-header .ast-cart-menu-wrap, i.astra-icon.ast-icon-shopping-bag, i.astra-icon.ast-icon-shopping-cart, i.astra-icon.ast-icon-shopping-basket' => array(
