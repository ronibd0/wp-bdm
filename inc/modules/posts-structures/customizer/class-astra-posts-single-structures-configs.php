		...
		foreach ( $post_types as $index => $post_type ) {
			...
			$_configs = array(
				...
				array(
					...
					'default' => astra_get_option( $title_section . '-text-font-extras' ),
				...
				array(
					...
					'type'    => 'sub-control',
					'control' => 'ast-font-extras',
					'default' => astra_get_option( $title_section . '-title-font-extras' ),
					'title'   => __( 'Font Extras', 'astra' ),
				),
				...
				array(
					...
					'type'    => 'sub-control',
					'control' => 'ast-font-extras',
					'default' => astra_get_option( $title_section . '-meta-font-extras' ),
					'title'   => __( 'Font Extras', 'astra' ),
				),
