...
const AutoBlockRecovery = () => {
    ...
    const updateEnableAutoBlockRecoveryStatus = () => {
		...
		formData.append( 'security', astra_admin.auto_block_recovery_nonce );
        ...
        <section className='block border-b border-solid border-slate-200 px-12 py-8 justify-between'>
            <div className='mr-16 w-full flex items-center'>
                <h3 className="p-0 flex-1 justify-right inline-flex text-lg leading-8 font-medium text-gray-900">
                    { __( 'Automatic Block Recovery', 'astra' ) }
                </h3>
                <Switch
            ...
            <p className="mt-2 w-9/12 text-sm text-slate-500">
                { __( 'Enable this to automatically recover any erroneous blocks that may occur on your web pages. This will save you time spent on clicking all those \"Attempt Block Recovery\" Buttons.', 'astra' ) }
            </p>
        </section>
    );
};
