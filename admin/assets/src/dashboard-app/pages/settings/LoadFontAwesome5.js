...
const LoadFontAwesome5 = () => {
    ...
    const updateEnableFontAwesome5Status = () => {
		...
		formData.append( 'security', astra_admin.load_font_awesome_5_nonce );
        ...
        <section className='block border-b border-solid border-slate-200 px-12 py-8 justify-between'>
            <div className='mr-16 w-full flex items-center'>
                <h3 className="p-0 flex-1 justify-right inline-flex text-lg leading-8 font-medium text-gray-900">
                    { __( 'Load Font Awesome 5 Support', 'astra' ) }
                </h3>
                <Switch
            ...
            <p className="mt-2 w-9/12 text-sm text-slate-500">
                { __( 'Enable this to make sure all previously used Font Awesome 5 icons are displayed correctly while using the Font Awesome 6 library.', 'astra' ) }
            </p>
        </section>
    );
};
