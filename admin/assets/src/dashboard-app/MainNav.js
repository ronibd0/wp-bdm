						...
						<div className="absolute bottom-2 lg:inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto ml-auto lg:ml-6 sm:pr-0">
							...
							<div className="flex items-center text-[0.625rem] sm:text-sm font-medium leading-[1.375rem] text-slate-400 mr-1 sm:mr-3 divide-x divide-slate-200 gap-3 pl-1 sm:pl-3">
								<div className="flex items-center">
									...
									<span className="ml-1 sm:ml-2 text-[0.625rem] leading-[0.625rem] font-semibold border border-slate-400 rounded-[0.1875rem] relative inline-flex flex-shrink-0 pt-0.5 pb-[0.15625rem] px-1"> { __( 'CORE', 'astra' ) } </span>
								</div>
								{ astra_admin.pro_available && (
									<div className="flex items-center pl-3">
										<span>{astra_admin.plugin_ver}</span>
										<span className="ml-1 sm:ml-2 text-[0.625rem] leading-[0.625rem] font-semibold text-white border border-slate-800 bg-slate-800 rounded-[0.1875rem] relative inline-flex flex-shrink-0 pt-0.5 pb-[0.15625rem] px-1"> {  __( 'PRO', 'astra' ) } </span>
									</div>
								)}
