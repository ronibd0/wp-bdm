...
( function( $ ) {
	...
	wp.customize( 'astra-settings[breadcrumb-font-extras]', function( value ) {
		value.bind( function( data ) {
			...
			astra_add_dynamic_css( 'breadcrumb-font-extras', dynamicStyle );
		});
	});
