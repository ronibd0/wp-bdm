...
const Astra_Admin_Icons = {
	...
	'spectra-logo': el(
		'svg',
		{ width: 126, height: 28, viewBox: '0 0 126 28', fill: 'none' },
		el( 'rect', {
			width: 126, height: 28, fill: 'url(#pattern0)',
		} ),
		el( 'pattern', {
			id: 'pattern0', patternContentUnits: 'objectBoundingBox', width: '1', height: '1'
		} ),
